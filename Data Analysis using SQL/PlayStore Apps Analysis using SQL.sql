...
Task 9: Get the number of reviews having positive sentiment and the number of reviews having negative sentiment for the app 10 best foods for You and compare them.
